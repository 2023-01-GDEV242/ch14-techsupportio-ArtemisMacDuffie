...
public class Responder
{
    ...
    // The name of the file containing the default and mapped responses.
    private static final String FILE_OF_DEFAULT_RESPONSES = "default.txt";
    private static final String FILE_OF_MAPPED_RESPONSES = "responses.txt";
    ...
    private void fillResponseMap()
    {
        ...
        try (BufferedReader reader = Files.newBufferedReader(path, charset)) {
            ...
            while (!complete) {
                ...
                String response = "";
                while (keywordLine != null && keywordLine.isBlank()) {
                    keywordLine = reader.readLine();
                }
                if (keywordLine == null) {
                    complete = true;
                }
                    ...
                    for (int index = 0; index < keywords.length; index++) {
                        keywordList.add(keywords[index]);
                    }
